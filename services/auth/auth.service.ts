  ...
  try {
    ...
    const updatedUser = await prisma.user.update({
      ...
      data: {
        ...
        countryIsoCode: countryIsoCode ?? user.countryIsoCode,
        provinceCode: provinceCode ?? user.provinceCode,
        cityCode: cityCode ?? user.cityCode,
        subDistrictCode: subDistrictCode ?? user.subDistrictCode,
        villageCode: villageCode ?? user.villageCode,
