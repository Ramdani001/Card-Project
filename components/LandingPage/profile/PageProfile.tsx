import { Box, Card, FileInput, Image, Paper, SimpleGrid, TextInput } from "@mantine/core";
        ...
        <Paper p="md" radius="xs" bg="white" withBorder style={{ borderColor: "#dee2e6" }}>
          <SimpleGrid cols={2}>
            ...
            <Box w={{ base: 100, md: 250, lg: 500 }}>
              <Card>
                <Card.Section>
                  <Image src="https://raw.githubusercontent.com/mantinedev/mantine/master/.demo/images/bg-8.png" height={360} alt="Norway" />
                </Card.Section>
              </Card>
            </Box>
          </SimpleGrid>
