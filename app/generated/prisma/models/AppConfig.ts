...
export type AppConfigWhereInput = {
  ...
  idConfig?: Prisma.IntFilter<"AppConfig"> | number
  code?: Prisma.StringFilter<"AppConfig"> | string
...
export type AppConfigScalarWhereWithAggregatesInput = {
  ...
  idConfig?: Prisma.IntWithAggregatesFilter<"AppConfig"> | number
  code?: Prisma.StringWithAggregatesFilter<"AppConfig"> | string
...
export type AppConfigOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"idConfig" | "code" | "value" | "createdAt" | "updatedAt", ExtArgs["result"]["appConfig"]>
...
export interface AppConfigDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const appConfigWithIdConfigOnly = await prisma.appConfig.findMany({ select: { idConfig: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many AppConfigs and only return the `idConfig`
   * const appConfigWithIdConfigOnly = await prisma.appConfig.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more AppConfigs and only return the `idConfig`
   * const appConfigWithIdConfigOnly = await prisma.appConfig.updateManyAndReturn({
   *   select: { idConfig: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface AppConfigFieldRefs {
  readonly idConfig: Prisma.FieldRef<"AppConfig", 'Int'>
  readonly code: Prisma.FieldRef<"AppConfig", 'String'>
